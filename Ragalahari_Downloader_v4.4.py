#A root folder named 'Ragalahari Downloads' will be created in the same directory as the script, and all downloaded image folders will be saved inside it.
#Folder name in specific Method like {directory_number}-{Custom_input}
